...
$relations_path = realpath( __DIR__ . '/../configs/relations-pulse-user.json' );
...
//Read config
$configFile = realpath( __DIR__ . '/../configs/minifier-user.json' );
...
foreach ($config['directives'] as $directive) {
    ...
    echo "\nRunning method for directive #". $directiveCounter;
